...
namespace EverGreenWebApi.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserModel Login(string phoneNumber, string otp, int loginId)
        {
            ...
            using (shamsweets_mobileappEntities context = new shamsweets_mobileappEntities())
            {
                ...
                if (result != null)
                {
                    ...
                    user.ProfilePictureUrl = "http://103.233.79.234/Data/ShamSweets_Android/ProfilePicture/" + result.LoginID + ".jpeg";
                }
            }
            return user;
        }
        ...
        public UserModel GetUserProfile(int loginid)
        {
            ...
            using (shamsweets_mobileappEntities context = new shamsweets_mobileappEntities())
            {
                ...
                if (result.LoginID > 0)
                {
                    ...
                    user.PhoneNumber = result.PhoneNumber;
                    user.EmailID = result.EmailID;
                    user.ProfilePictureUrl = "http://103.233.79.234/Data/ShamSweets_Android/ProfilePicture/" + user.LoginID + ".jpeg";
                }
            }
            return user;
        }
        ...
        public UserModel IsMobileVerified(int loginid)
        {
            ...
            using (shamsweets_mobileappEntities context = new shamsweets_mobileappEntities())
            {
                ...
                if (result.LoginID > 0)
                {
                    ...
                    user.PhoneNumber = result.PhoneNumber;
                    user.EmailID = result.EmailID;
                    user.ProfilePictureUrl = "http://103.233.79.234/Data/ShamSweets_Android/ProfilePicture/" + user.LoginID + "ProfilePicture.jpg";
                }
            }
            return user;
        }
            ...
            using (shamsweets_mobileappEntities context = new shamsweets_mobileappEntities())
            {
                ...
                if (data != null)
                {
                    ...
                    if (us != null)
                    {
                        ...
                        try
                        {
                            //user.ProfilePictureUrl = "http://103.233.79.234/Data/ShamSweets_Android/ProfilePicture/" + us.LoginID + ".jpeg";
                            string path = "C:/inetpub/wwwroot/Data/ShamSweets_Android/ProfilePicture/" + model.LoginID + ".jpeg";
                ...
                else
                {
                    ...
                    if (result > 0)
                    {
                        ...
                        if (userdata != null)
                        {
                            try
                            {
                                string path = "C:/inetpub/wwwroot/Data/ShamSweets_Android/ProfilePicture/" + u.LoginID + ".jpeg";
        ...
        public Int32 SendOTP(string phonenumber)
        {
            ...
            string _messageText = HttpUtility.UrlEncode("Your ShamSweets's Password is " + Convert.ToString(rand)); // text message
