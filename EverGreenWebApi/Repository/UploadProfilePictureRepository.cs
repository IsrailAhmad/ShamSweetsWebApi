        ...
        public UserModel UploadProfilePicture(int loginid)
        {
            ...
            using (shamsweets_mobileappEntities context = new shamsweets_mobileappEntities())
            {
                ...
                if (data != null)
                {
                    ...
                    users.ProfilePictureUrl = "http://103.233.79.234/Data/ShamSweets_Android/ProfilePicture/" + users.LoginID + ".jpg"; 
                    //users.ProfilePictureUrl = "http:/localhost:51673/Data/ShamSweets_Android/ProfilePicture/" + loginid + ".jpg";
