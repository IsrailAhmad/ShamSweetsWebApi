...
namespace EverGreenWebApi.Repository
{
    public class MenuMasterRepository : IMenuMasterRepository
    {
                ...
                if (StoreId == 0)
                {
                    data = (from m in context.menumasters
                            ...
                            select new MenuMasterModel()
                            {
                                ...
                                ImageUrl = "http://103.233.79.234/Data/ShamSweets_Android/MenuPictures/" + m.MenuId + ".jpg",
                                //ImageUrl = "http://localhost/Data/ShamSweets_Android/MenuPictures/" + m.MenuId + ".jpg",
                            }).ToList();
                }
                else
                {
        ...
        {
            //string path = "http://103.233.79.234/Data/ShamSweets_Android/MenuPictures/";
